...
<div class="wrapper">
    ...
    ?>
        ...
        <div class="t2">
            <div id="categorys-container">
               ...
               <div id="Habeshan" class="category">
               ...
               <div id="Japanese" class="category">
               ...
               <div class="s2">
                   <h2>Manti</h2>
               <p>
                   Small Turkish dumplings filled with spiced ground meat and served with a creamy yogurt sauce and a drizzle of melted butter and with red pepper flakes.
               </p>
            ...
            <button onclick="openRecipePage('Kısır (Bulgur Salad)')">MAKE THIS RECIPE</button>
              ...
              <div class="AA">
               ...
               <div class="AA">
                   ...
                   <p>These Tacos are bursting with flavor, thanks to the marinated chicken and tangy mango salsa.</p>
    ...
    document.querySelectorAll('.category').forEach(category => {
        category.style.display = 'none';
                ...
                const categoryId = urlParams.get('recipe');
