...
<div class="wrapper">
   ...
   <div class="t2">
    <div class="category-container">
        <div id="Quick and Easy" class="categories">
            ...
            <div class="AA">
                <div class="category">
                    ...
                    <div class="s2">
                    <h2>Hummus</h2>
                    <p>Hummus is a delicious and nutritious Middle Eastern dip.</p>
                    ...
                    <div class="s2">
                        <h2>Loaded Beef Nachos</h2>
                        <p>A hearty and flavorful appetizer featuring crispy tortilla chips loaded with seasoned beef.</p>
                    ...
                    <div class="category">
                     ...
                     <div class="category">
                        ...
                        <div class="s2">
                            <h2>Seven Layer Party Dip </h2>
                        <p>A layered appetizer featuring refried beans, guacamole, salsa, sour cream, and fresh toppings.</p>
                    ...
                    <div class="s2">
                        <h2>Frittata</h2>
                    <p>A versatile Italian egg dish filled with a delicious combination of vegetables, cheese, and seasonings.</p>
                    ...
                    <button onclick="openRecipePage('Chow Mein')">MAKE THIS RECIPE</button>
                     ...
                     <div class="category">
                       ...
                       <div class="s2">
                        <h2>Tabbouleh</h2>
                        <p>Tabbouleh is a refreshing Middle Eastern salad made with bulgur wheat, fresh herbs, tomatoes, and lemon dressing.</p>
                    ...
                    <div class="category">
                      ...
                      <p> Gyoza are Japanese dumplings filled with ground meat and vegetables, pan-fried.</p>
            ...
            <button onclick="openRecipePage('Cold Sesame Noodles')">MAKE THIS RECIPE</button>
                    ...
                    <div class="s2">
                        <h2>Caprese Salad</h2>
                    <p>A salad featuring ripe tomatoes, fresh mozzarella, and basil leaves, drizzled with balsamic glaze and olive oil.</p>
        ...
        <div id="Popular" class="categories">
            <h1>Popular</h1>
            <div class="AA">
                <div class="category">
                ...
                <div class="s2">
                    <h2>Baklava</h2>
                <p>Baklava is a sweet pastry made of layers of filo dough filled with chopped nuts and sweetened with honey.</p>
                ...
                <div class="category">
                 ...
                 <p>Doro Wat is a rich and flavorful spicy chicken stew.</p>
                ...
                <div class="s2">
                    <h2>Kunafa</h2>
                <p>Kunafa is a traditional dessert made with shredded phyllo dough, filled with cheese, and soaked in syrup.</p>
                ...
                <div class="category">
                    ...
                    <div class="s2">
                        <h2>Tagine</h2>
                    <p>Tagine is a stew originating from North Africa, combining meat, vegetables, and aromatic spices.</p>
        ...
        <button onclick="openRecipePage('Sweet and Sour Pork')">MAKE THIS RECIPE</button>
                ...
                <div class="category">
                    ...
                    <p>A popular pizza loaded with tomato sauce, mozzarella cheese, and spicy pepperoni slices.</p>
                ...
                <p>These Tacos has a great flavor, thanks to the marinated chicken and tangy mango salsa.</p>
               ...
               <div class="category">
                ...
                <p> A delicious Mexican breakfast dish,a crispy tortilla chips drenched in a rich and smoky salsa roja.</p>
                ...
                <div class="category">
                 ...
                 <p>Ethiopian dish of finely minced raw beef, flavored with spiced clarified butter.</p>
                ...
                <div class="s2">
                    <h2>Sambussa</h2>
                <p>Sambussa is a Ethiopian snack filled with lentils or minced meat, wrapped in a crispy dough, and deep-fried.</p>
                ...
                <p>Japanese dish where chicken is grilled and glazed with a sweet soy sauce.</p>
                ...
                <div class="category">
                  ...
                  <p>A classic pizza featuring a thin crust topped with tomato sauce, fresh mozzarella, and basil leaves.</p>
        ...
        <div id="Healthy" class="categories">
            <h1>Healthy</h1>
            <div class="AA">
                <div class="category">
                ...
                <div class="category">
                   ...
                   <div class="s2">
                    <h2>Tabbouleh</h2>
                    <p>Tabbouleh is a refreshing Middle Eastern salad made with bulgur wheat, fresh herbs, tomatoes, and a lemon dressing.</p>
                    <button onclick="openRecipePage('Tabbouleh')">MAKE THIS RECIPE</button>
                   </div>
                </div>
                ...
                <p> Agedashi Tofu features deep-fried tofu served in a savory dashi broth.</p>
                ...
                <div class="s2">
                    <h2>Injera</h2>
                <p>Injera is a traditional Ethiopian flatbread, fermented and spongy in texture.</p>
                ...
                <div class="s2">
                    <h2>Shorbat Adas</h2>
                <p>Shorbat Adas, a hearty lentil soup, is a staple in Middle Eastern cuisine,offering nutritious meal.</p>
                <button onclick="openRecipePage('Shorbat Adas')">MAKE THIS RECIPE</button>
                </div>
                </div>
                ...
                <div class="s2">
                    <h2>Caponata</h2>
                <p>A savory Sicilian vegetable dish made with eggplant, tomatoes, and olives.</p>
               ...
               <div class="s2">
                <h2>Gomen</h2>
                <p>Gomen is a traditional Ethiopian dish made from collard greens or kale.</p>
               ...
               <div class="category">
                ...
                <div class="s2">
                    <h2>Avocado Salad</h2>
                    <p> A creamy and flavorful avocado salad that combines fresh vegetables with cilantro and a tangy lime dressing .</p>
    ...
    <div id="Vegan" class="categories">
        ...
        <div class="AA">
            ...
            <div class="s2">
                    <h2>Baba Ganoush</h2>
            <p>A smoky and creamy Middle Eastern dip made from roasted eggplants, tahini, olive oil, lemon juice, and garlic.</p>
           ...
           <div class="s2">
            ...
            <div class="category">
                ...
                <div class="category">
                    ...
                    <div class="s2">
                        <h2>Green Chicken Enchilada Soup</h2>
          <p>A creamy soup made with shredded chicken, green enchilada sauce.</p>
    ...
    fetch("header.php").then(response => response.text()).then(data => {
      ...
      document.querySelectorAll('.categories').forEach(categories => {
        categories.style.display = 'none';
                ...
                const categoriesId = urlParams.get('recipe');
